...
<html xmlns="http://www.w3.org/1999/xhtml" xmlns:fb="http://www.facebook.com/2008/fbml" xmlns:fb="http://ogp.me/ns/fb#" xml:lang="<?php print $language->language ?>" lang="<?php print $language->language ?>" dir="<?php print $language->dir ?>">
  <head>
  <?php print $head; ?>
...
<div id="header-wrapper">
	...
	<?php global $user; 
		if ($user->uid != 0) { 
			...
			print '<li class="anunciar">'.'<a href="'. url('node/add/anuncios').'">'.t('Anunciar').'</a></li>';
...
<div style="clear:both"></div>
<div id="notice"><p>Sitio desarrollado en <a href="http://www.drupal.org">Drupal</a> Por <a href="http://pe.linkedin.com/pub/eduardo-cabrera-japa/35/772/90"> Eduardo Cabrera Japa</a></p></div>
<?php print $closure; ?>
</body>
</html>
